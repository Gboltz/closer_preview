                        ...
                        <div class="login-box">
                            <div class="login-content">
                                <div class="col-md-6 info">
                                    ...
                                    <h2>Bonjour!</h2>
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente numquam unde laborum nesciunt magni pariatur voluptate omnis, ea amet tenetur, consectetur laboriosam rem alias eaque harum ratione temporibus. Asperiores, vero.
                                    </p>
                                </div>
                                <div class="col-md-6 content">
                                    ...
                                    <div class="sign-up">
                                        <p>
                                            Vous n'avez pas de compte ? <a href="<?= $action->helper->url('signup') ?>">S'inscrire</a>
                                        </p>
                                    </div>
