...
<head>
    ...
    <link rel="stylesheet" href="<?= $action->helper->loadCss('cv2/css/bootstrap.css') ?>">
    <link rel="stylesheet" href="<?= $action->helper->loadCss('cv2/css/normalize.css') ?>">
    <link rel="stylesheet" href="<?= $action->helper->loadCss('cv2/css/transition-animations.css') ?>">
    <link rel="stylesheet" href="<?= $action->helper->loadCss('cv2/css/owl.carousel.css') ?>">
    <link rel="stylesheet" href="<?= $action->helper->loadCss('cv2/css/magnific-popup.css') ?>">
    <link rel="stylesheet" href="<?= $action->helper->loadCss('cv2/css/animate.css') ?>">
    <link rel="stylesheet" href="<?= $action->helper->loadCss('cv2/css/main.css') ?>" type="text/css">

    <script src="<?= $action->helper->loadCss('cv2/js/jquery-2.1.3.min.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/modernizr.custom.js') ?>"></script>
...
<body>
    ...
    <script src="<?= $action->helper->loadCss('cv2/js/bootstrap.min.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/page-transition.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/imagesloaded.pkgd.min.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/validator.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/jquery.shuffle.min.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/masonry.pkgd.min.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/owl.carousel.min.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/jquery.magnific-popup.min.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/jquery.hoverdir.js') ?>"></script>
    <script src="<?= $action->helper->loadCss('cv2/js/main.js') ?>"></script>
