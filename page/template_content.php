...
<body class="bg-gray">
            ...
            <div class="row">
                <div class="team-items text-center">
                    ...
                    <div class="col-md-4 equal-height">
                        <div class="item" style="margin-top: 20px; background-color: white;">
                            <div class="thumb">
                                <img src="<?= $action->helper->loadImage('pf.png') ?>" class="img-fluid " alt="...">
                                <ul>
                                    <li class="facebook">
                                        <a href="<?= $action->helper->url('preview') ?>"><i class="fa-solid fa-eye"></i></a>
                                    </li>

                                </ul>
                            </div>
                            <div class="info">
                                <h4>Modèle par defaut</h4>
                                <span>
                                    Modèle de Portfolio gratuit et simple.</span>
                                <a href=" <?= $action->helper->url('cv_details/1') ?>" class="btn btn-sm btn-primary"><i class="bi bi-file-earmark-plus"></i> CREER</a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Item -->
    ...
    <script src="https://kit.fontawesome.com/98ac306de2.js" crossorigin="anonymous"></script>
