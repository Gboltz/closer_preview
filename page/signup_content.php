                        ...
                        <div class="login-box">
                            <div class="login-content">
                                <div class="col-md-6 info">
                                    ...
                                    <h2>Bonjour!</h2>
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad quod sint corrupti temporibus numquam culpa eos aliquam laboriosam sit autem similique, ipsa, alias dolor animi id? Temporibus nobis quod eos!
                                    </p>
                                </div>
                                <div class="col-md-6 content">
                                    ...
                                    <form method="POST" action=" <?= $action->helper->url('action/signup') ?>">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="row">
                                                <div class="form-group">
                                                    <input class="form-control" name="full_name" placeholder="Nom" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="row">
                                                <div class="form-group">
                                                    <input class="form-control" name="password_confirm" placeholder="Confirmez Mot de passe*" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="sign-up">
                                        <p>
                                            ...
                                            Vous avez déjà un compte? <a href="<?= $action->helper->url('login') ?>">Se connecter</a>
                                        </p>
                                    </div>
