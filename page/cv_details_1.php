                        ...
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <div class="comments-form">
                                    ...
                                    <form method="POST" action="<?= $action->helper->url('action/createresume') ?>" class="border border-2 rounded-2 p-2 my-3" enctype="multipart/form-data">
                                        <div class="row">
                                            <input id="modèle" name="modele" type="hidden" value="1">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group" style="margin-top: 10px;">
                                                    ...
                                                    <input class="form-control" name="image" type="file" placeholder="Image de profil">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group" style="margin-top: 10px;">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class=" mb-3 border">
                                                    ...
                                                    <div class="" style="margin-top: 20px;">
                                                        <input type="text" class="form-control w-30" id="college" placeholder="Intitulé de la formation">
                                                        <input type="text" class="form-control" id="e_duration" placeholder="2021-2022">
                                                        <textarea type="text" class="form-control" id="course" placeholder="Descriptif de la fomation"></textarea>
                                                ...
                                                <br>
                                                <div class="form-group full-width submit text-center">
    ...
    <script>
        ...
        $("#addExps").click(function() {
            ...
            ${about}
                    ...
                    <p>${about}</p>
                    <button type="button" class="btn-sm btn-danger" onclick="removeExps(this)">Supprimer</button>
                </div>`);
            $("#company").val(``);
            $("#jobrole").val(``);
            $("#c_duration").val(``);
