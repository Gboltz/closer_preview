    ...
    <div id="features" class="features-area carousel-shadow default-padding ">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2 ">
                    <div class="site-heading text-center">
                        <a href="<?= $action->helper->url('select_template') ?>" class="btn btn-sm btn-primary"><i class="bi bi-plus-square"></i> Créer Nouveau Portfolio</a>
                    ...
                    <div class="features-items features-carousel owl-carousel owl-theme">
                        ...
                        ?>
                            <div class="item">
                                ...
                                <div class="info">
                                    <h4><?= $resume['firstname'] ?> <?= $resume['name'] ?></h4>
                                    <p>
                                        Créer le : <?= $resume['created_at'] ?>
                                    </p>

                                    <div class="bottom">
                                        <a href="<?= $action->helper->url("resume/" . $resume['url'] . "/" . $resume['modele'] . "/" . $resume['id']) ?>">Voir Portfolio <i class="fas fa-angle-right"></i></a>
                                    </div>
                                    <div class="bottom">
                                        <a onclick="copyurl('<?= $action->helper->url("resume/" . $resume['url'] . "/" . $resume['modele'] . "/" . $resume['id']) ?>')">Copier URL <i class="fas fa-angle-right"></i></a>
                                    </div>
                                    <div class="bottom">
                                        <a href="<?= $action->helper->url("action/deleteresume/" . $resume['url']) ?>">Supprimer <i class="fas fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
